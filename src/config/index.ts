...
export type TEMPLATE_TYPES = 'EMPTY_DEFAULT' | 'ROLLUP_TS' | 'WEBPACK_TS' | 'TARO3_REACT_TS' | 'TARO3_VUE3_TS' | 'TARO3_VUE2_TS' | 'TARO2_TS' | 'WEBPACK_REACT_TS' | 'WEBPACK_VUE3_TS' | 'WEBPACK_VUE2_TS' | 'VITE_REACT_TS' | 'VITE_VUE3_TS'
